...
void CSaveLoadMgr::LoadScene(const wstring & _strScenePath)
{
	...
	CHierachyView* pHierachyView = (CHierachyView*)(pFrame)->GetHierachyView();
	pHierachyView->Reset();

	CComponentView* pComponentView = (CComponentView*)(pFrame)->GetComponentView();
	pComponentView->SetTargetObject(nullptr);
	...
	pHierachyView = (CHierachyView*)(pFrame)->GetHierachyView();
	pHierachyView->Reset();
}
...
void CSaveLoadMgr::SavePrefabObject(CGameObject * _pPrefabObj, FILE * _pFile)
{
...
void CSaveLoadMgr::SavePrefab(const map<wstring, CRes*>& _mapPrefab, FILE * _pSceneFile, FILE* _pPrefabFile)
{
