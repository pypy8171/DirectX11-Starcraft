...
void CMaterial::UpdateData()
{
	...
	{	
		if(nullptr != m_arrTex[i])
			m_arrTex[i]->SetRegisterAll(i); // 모든 시점에 텍스쳐 전달.
	}
...
void CMaterial::Load(const wstring & _strFullPath, const wstring & _strKey)
{
}
...
{// Material Key
	...
	//if (nullptr == CResMgr::GetInst()->Load<CMaterial>(strMtrlName))
	//{
